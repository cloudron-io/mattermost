...
export default class ChooseAuthPage extends React.Component {
    ...
    render() {
        ...
        if (global.window.mm_config.EnableSignUpWithOAuth === 'true') {
            for (var provider in global.window.mm_config.CustomOAuthProviders) {
                var displayName = global.window.mm_config.CustomOAuthProviders[provider]
                buttons.push(
                        <a
                            ...
                            onClick={
                                (e) => {
                                    e.preventDefault();
                                    this.props.updatePage(provider);
                                }
                            }
                        >
                        <span className='icon' />
