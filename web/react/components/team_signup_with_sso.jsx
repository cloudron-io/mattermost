...
export default class SSOSignUpPage extends React.Component {
    ...
    render() {
        ...
        } else if (this.props.service in global.window.mm_config.CustomOAuthProviders) {
            var displayName = global.window.mm_config.CustomOAuthProviders[this.props.service]
            button = (
                <a
